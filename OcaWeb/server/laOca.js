...
var LaOca = function(tablero, coleccionFichas) {
...
function FaseJugar(juego) {
    ...
    this.lanzar = function (jugador) {
        return jugador.turno.lanzar(jugador);
    }
...
function Posada() {
    this.titulo = "Posada";
    this.mensaje = "Caiste en la Posada y pierdes dos turnos";
    this.cae = function (ficha) {
        console.log(mensaje);
...
function Pozo() {
    this.titulo = "Pozo";
    this.pozo = undefined;
    this.mensaje="Caiste en el pozo";
...
function Laberinto() {
    ...
    this.mensaje="Caiste en el Laberinto";
...
function Carcel() {
    this.titulo = "Carcel";
    this.mensaje="Caiste en la Cárcel";
...
function Calavera() {
    ...
    this.mensaje="Caiste en la Calavera"
...
var Jugador=function(nombre, juego) {
    ...
    this.lanzar = function () {
        return this.juego.fase.lanzar(this);
    }
